...
{
    [Route("api/BracoEsquerdo/Pulso")]
    public class BracoEsquerdoPulsoController : Controller
    {
        private readonly IPulsoEsquerdoAppServico _pulsoAppServico;

        public BracoEsquerdoPulsoController(IPulsoEsquerdoAppServico pulsoAppServico)
        {
